...
A concise web CV is provided below. For the latest PDF version, please use [Download CV](/files/Hong_Wang_CV.pdf). You can also view [Lab Discussion Slides](/files/Hong_Wang_Presentation.pptx).
...
Education
======
- **Ph.D. student, Artificial Intelligence track**, School of Information Science and Technology, USTC, 2023-present
- **M.S., Computational Mathematics**, School of Mathematical Sciences, USTC, 2021-2023  
  Advisor: Prof. [Kuan Xu](http://staff.ustc.edu.cn/~kuanxu/index.html)
- **B.S., Theoretical Physics; B.S., Mathematics (double degree)**, School of the Gifted Young, USTC, 2017-2021

Internship and Projects
======
- **Tencent AI Code Assistant (CSIG CodeBuddy) Team, Qingyun Program — Research Intern**, May 2025 - December 2025  
  Worked on LLM post-training for code and mathematical reasoning, focusing on RLVR, entropy dynamics, and data curation for code RL.
- **Huawei Project: Fast Similar Matrix Computation via Low-Rank Decomposition**, September 2021 - June 2022  
  Led literature review, algorithm design, theory, experiments, and reporting; developed accelerated matrix algorithms with 1.2×–20× speedups.

Awards
======
- Doctorate National Scholarship, USTC
- Graduate Academic Scholarship, USTC
...
- **Accelerating Data Generation for Neural Operators via Krylov Subspace Recycling**  
  ...
  *ICLR 2024 Spotlight*. [[arXiv]](https://arxiv.org/abs/2401.09516)
...
- **Coordinate Transform Fourier Neural Operators for Symmetries in Physical Modelings**  
  ...
  *TMLR 2025*. [[OpenReview]](https://openreview.net/forum?id=pMD7A77k3i) [[code]](https://github.com/wenhangao21/CTFNO)
- **Test-Time Policy Adaptation for Enhanced Multi-Turn Interactions with LLMs**  
  Authors: Chenxing Wei, **Hong Wang**, Ying He, Fei Yu, Yao Shu.  
  Submitted to *ICML 2026*. [[arXiv]](https://arxiv.org/abs/2509.23166)
- **Words & Weights: Streamlining Multi-Turn Interactions via Co-Adaptation**  
  Authors: Chenxing Wei, **Hong Wang**, Ying He, Zhongxiang Dai, Bo Jiang, F. Richard Yu, Yao Shu.  
  Submitted to *ICML 2026*. [[arXiv]](https://arxiv.org/abs/2603.01375)
